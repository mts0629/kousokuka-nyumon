...
.LVL10:
	.loc 1 26 0 discriminator 2
	movss	24(%rsp,%rdx,4), %xmm0
	.loc 1 25 0 discriminator 2
	cmpl	$65536, %eax
	.loc 1 26 0 discriminator 2
	movss	12(%rsp), %xmm5
	movss	24(%rsp,%rdx,4), %xmm2
	mulss	%xmm5, %xmm0
	movss	16(%rsp), %xmm4
	mulss	%xmm4, %xmm2
	movss	24(%rsp,%rdx,4), %xmm1
	movss	20(%rsp), %xmm3
	mulss	%xmm3, %xmm1
	addss	%xmm2, %xmm0
	addss	%xmm1, %xmm0
	movss	%xmm0, 262168(%rsp,%rdx,4)
	.loc 1 25 0 discriminator 2
	jne	.L3
.LVL11:
.LBE10:
...
.LASF148:
	.string	"tm_isdst"
.LASF172:
	.string	"GNU C++14 7.5.0 -mtune=generic -march=x86-64 -g -Os -fstack-protector-strong"
.LASF18:
	.string	"_IO_read_end"
.LASF9:
	.string	"short int"
